...
func _ready():
	...
	set_texture_scale_1(texture_scale_2)
	set_texture_map_1(texture_map_2)
	set_normal_map_1(normal_map_2)
	set_pbr_map_1(pbr_map_2)
	
	set_texture_scale_1(texture_scale_3)
	set_texture_map_1(texture_map_3)
	set_normal_map_1(normal_map_3)
	set_pbr_map_1(pbr_map_3)
	
	set_texture_scale_1(texture_scale_4)
	set_texture_map_1(texture_map_4)
	set_normal_map_1(normal_map_4)
	set_pbr_map_1(pbr_map_4)
	
	set_texture_scale_1(texture_scale_5)
	set_texture_map_1(texture_map_5)
	set_normal_map_1(normal_map_5)
	set_pbr_map_1(pbr_map_5)
